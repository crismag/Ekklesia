...
The print studio turns what is on the calendar into something you can put on a noticeboard, hand out at the door, or send as a PDF. It builds a real document — not this website with print styles laid over it — which is why a printed month looks like a wall calendar rather than a screenshot of one.
...
> **Warning:** Publications do not store the campus. The campus selector in the top bar still decides whose events appear, so check it before printing.
