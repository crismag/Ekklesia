...
final class Workspaces
{
        ...
        return [
            ...
            [
                ...
                'pages' => [
                    ...
                    ['id' => 'history', 'label' => 'Record history', 'href' => '/people/history', 'icon' => 'availability-short', 'need' => 'admin', 'match' => ['/people/history']],
            ...
            [
                ...
                'pages' => [
                    ...
                    ['id' => 'appearance', 'label' => 'Portal appearance & notices', 'href' => '/admin/announcements', 'icon' => 'docs', 'need' => 'admin', 'match' => [], 'children' => [
                        ['id' => 'announcements', 'label' => 'Portal notices', 'href' => '/admin/announcements', 'need' => 'admin', 'match' => ['/admin/announcements', '/admin/announcements/*', '/admin/hero']],
                    ...
                    ['id' => 'history', 'label' => 'Activity history', 'href' => '/admin/history', 'icon' => 'availability-short', 'need' => 'admin', 'match' => ['/admin/history']],
    ...
    public static function adminSections(): array
    {
        return [
            ...
            'record-history' => ['people', 'history', null],
