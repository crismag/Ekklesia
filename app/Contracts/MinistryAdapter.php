...
interface MinistryAdapter
{
    ...
    /**
     * Resolve a campus/ministry-friendly path like /scheduler/northyork/hospitality.
     * Campus-specific ministries win over multi-campus (NULL campus_id) ministries
     * when both names normalize to the same slug.
     *
     * @return array{
     *   campus_id:int,
     *   campus_name:string,
    ...
    /**
     * Resolve a scheduler path like /scheduler/victuals?campus=scarborough,northyork.
     * When campus filters are provided they are used to disambiguate same-slug
     * ministries; an empty campus list means "all campuses".
     *
    ...
    /**
     * Directory rows for all people, optionally narrowed to a person id and/or
     * campus. Ministry membership is included as informational metadata only.
     *
     * @return list<array{
     *   person_id:int,
     *   display_name:string,
