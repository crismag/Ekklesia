...
/**
 * What the Visitors workspace reads from the member database (MySQL): people
 * to match against, the options a promotion chooses from, and event names for
 * RSVPs. Writes only the parts of a promoted person PersonAdminService::save()
 * does not.
 */
interface VisitorMemberAdapter
{
    /**
