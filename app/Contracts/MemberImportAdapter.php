 ...
 *
 * Source-specific: implementations own the SQL and the storage encoding (for
 * example the JSON columns). Everything above this boundary — worksheet
 * parsing, merging, de-duplication, which rows are ready to apply — is
 * business logic and belongs in the service.
 */
interface MemberImportAdapter
{
    /**
